...
<?php
//konfigurasi koneksi
mysql_connect ("localhost","user","kucing");
...
$kueri = mysql_query ("INSERT INTO tb_komentar(nama, website, pesan, tanggal, time) values
('$_POST[nama]', '$_POST[website]', '$_POST[pesan]', '$tanggal','$time')");
